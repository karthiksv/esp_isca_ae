...
for i in range (Npass):
	print(i)
	Nway=17#Enables random pairing
	sq_n,foo1,a,foo3,max_err[i],foo5=one_pass(autostop,eps,N,Ttot,Tstep_avg,Tstep_range,tmax,Navg_need,circular,norm,False,Nway,2000,100)
...
for i in range (Npass):
	print(i)
	Nway=16#Disables random pairing
	sq_n,foo1,a,foo3,max_err[i],foo5=one_pass(autostop,eps,N,Ttot,Tstep_avg,Tstep_range,tmax,Navg_need,circular,norm,False,Nway,2000,100)
...
print("Residual error statistics without/with random pairing:")
